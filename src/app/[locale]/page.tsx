  ...
  return (
    <>
      <section>
        ...
        <div className='w-screen h-[450px] flex justify-center'>
          <div className='w-full h-full flex flex-col-reverse bg-onda bg-cover bg-[-240px] md:flex-row md:bg-center md:w-[90%] xl:w-[70%]'>
            ...
            <div className='w-full h-full flex justify-center items-start pt-8 pl-20 pr-8 md:pl-0 md:pt-8 md:pr-8 
                  md:items-start md:w-[50%] lg:items-center lg:pt-0 xl:pr-0'>
              <p className='text-md text-[#05090a] font-semibold text-right md:text-bluedark md:text-left  md:text-xl xl:px-20'>
      ...
      <section className='w-screen h-full flex justify-start items-center flex-col relative mt-14 mb-10 md:h-[300px] lg:h-[250px]'>
        ...
        <div className='w-full flex justify-center items-start flex-col md:w-[85%] md:flex-row z-20 xl:w-[65%]'>
          <div className='w-full h-full flex justify-start flex-col'>
            <div className='w-full h-[56px] flex justify-between items-center'>
              <h6 className='text-[12px] font-semibold text-white pl-6 uppercase font-conthrax md:text-md lg:text-xl'>
                {t('about')}
              </h6>
          ...
          <div className='w-full h-full flex justify-center mt-10 md:mt-0 md:justify-end'>
            <video className="w-full h-full object-cover border-white hover:border-[1px] md:rounded-2xl md:w-[90%]"
              src="https://cdn.pixabay.com/video/2023/09/30/182970-869947284_tiny.mp4"
              controls
            />
          </div>
      ...
      <section className='w-screen bg-gray-100 flex justify-center items-center flex-col md:h-[350px]'>
        <div className='w-full pl-6 h-full md:w-[85%] xl:w-[65%]'>
      ...
      <section className='w-screen bg-bluedark flex justify-center'>
        <div className='w-[95%] flex flex-col justify-center items-center py-16 justify-items-center lg:flex-row lg:justify-between'>
      ...
      <section className='w-screen flex flex-col justify-center items-center'>
        ...
        <div className='w-full h-[400px] flex justify-between items-center flex-col my-5 md:space-x-8 md:w-[85%] md:h-[240px] md:flex-row xl:w-[65%]'>
          <div className='w-full md:w-[50%]'>
            <p className='text-[15px] text-bluedark font-nexa pl-6 pr-6 text-justify mb-4 md:mb-0 md:pr-0'>
              {t("r-s-p")}
            </p>
          </div>
